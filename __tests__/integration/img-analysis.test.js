...
describe("Image analyser test suite", () => {
  test("it should analyse successfuly the image returing the results", async () => {
    const finalText = [
  ...
  test("given an empty queryString it should return statusCode 400", async () => {
    const expected = {
      statusCode: 400,
  ...
  test("given an invalid ImageURL queryString it should return 500", async () => {
    const expected = {
      statusCode: 500,
